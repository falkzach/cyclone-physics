...
//    cyclone::Vector3 point = cyclone::Vector3(0.0, 5.0, 5.0);
    cyclone::ParticleLighter ppg = cyclone::ParticleLighter(1.0);
...
void BallisticDemo::fire()
{
    ...
    case FIREBALL:
        ...
        shot->particle.setVelocity(0.0f, 0.0f, 1.0f); // 5m/s
        shot->particle.setAcceleration(0.0f, 0.0f, 0.0f); // Floats up
