...
class BallisticDemo : public Application
{
    ...
    cyclone::DistanceSquareGravity dsg = cyclone::DistanceSquareGravity(point, 100000.0);
...
void BallisticDemo::update()
{
    ...
    cyclone::real duration = (float)TimingData::get().lastFrameDuration * 0.001f;
